...
import { registerAction, saveGoogleUserToFirestore } from '../auth/actions';
    ...
    const handleGoogleSignIn = async () => {
       ...
       try {
         ...
         toast({
            ...
            description: `حدث خطأ غير متوقع: ${error.code}. يرجى المحاولة مرة أخرى.`,
         });
       }
    };
    ...
    <div className="flex min-h-[80vh] items-center justify-center bg-secondary/20" dir="rtl">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            أدخل معلوماتك لإنشاء حساب جديد في المتجر.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            ...
            <form className="space-y-4" action={formAction}>
              <div className="space-y-2">
                ...
                <Input id="name" name="name" type="text" placeholder="اسمك الكامل" required />
